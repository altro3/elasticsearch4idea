...
class Notifier(private val project: Project) {
    private val notificationGroup = NotificationGroup.logOnlyGroup("Elasticsearch")
    ...
    private fun notify(message: String, notificationType: NotificationType) {
        notificationGroup.createNotification("[ElasticsearchPlugin] $message", notificationType)
            .notify(project)
    }
