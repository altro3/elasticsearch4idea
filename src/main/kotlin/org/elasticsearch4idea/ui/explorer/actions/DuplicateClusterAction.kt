...
class DuplicateClusterAction(private val elasticsearchExplorer: ElasticsearchExplorer) :
    DumbAwareAction("Duplicate...", "Duplicate Cluster Configuration", AllIcons.Actions.Copy) {
